                ...
                <div className={`navbar--items ${navActive ? "active" : ""}`}>
                    <ul>
                        <li>
                            ...
                            spy={true} smooth={true} offset={-70} duration={500} to="heroSection"
                        ...
                        <li>
                            <Link onClick={closeMenu} activeClass="navbar--active-content"
                            spy={true} smooth={true} offset={-70} duration={500} to="Works"
                            className="navbar--content">
                                WorKs
                            </Link>
                        </li>
                        <li>
                            <Link onClick={closeMenu} activeClass="navbar--active-content"
                            spy={true} smooth={true} offset={-70} duration={500} to="Contact"
                            className="navbar--content">
                                Contact Me
                            </Link>
                        </li>
